...
const V2Page = () => (
  <Container>
    ...
    <GridContainer>
      ...
      <GridBlock row="3" col="2" width="4" height="4" border="white">
        <BodyText>
          <p>Daze, Giving you introspection for a better everyday.</p>
        </BodyText>
      </GridBlock>

      <GridBlock row="7" col="2" width="1" height="1" border="white"/>

      <GridBlock row="7" col="3" width="2" height="1" bg="white" above>
        <BodyText color={green}>
          <SmallText>Install Now</SmallText>
        </BodyText>
      </GridBlock>
